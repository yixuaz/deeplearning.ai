...
for iteration in range(number_of_iterations):
    ...
    print(running_var)
    hidden_before_relu, x_normalized, sample_mean, sample_var, running_mean, running_var = batchnorm_forward(
        hidden_before_relu, gamma, beta, 'train', running_mean, running_var)
    ...
    print(dhidden)
    dhidden[hidden <= 0] = 0
    print("Before batchnorm_backward, H = ")
    print(hidden)
    print("Before batchnorm_backward, dH = ")
    print(dhidden)
    print("Before batchnorm_backward, gamma = ")
    print(gamma)
    print("Before batchnorm_backward, beta = ")
    print(beta)
    print("Before batchnorm_backward, mean = ")
    print(sample_mean)
    print("Before batchnorm_backward, var = ")
    print(sample_var)
    print("Before batchnorm_backward, H_normalized = ")
    print(x_normalized)
    dhidden, dgamma, dbeta = batchnorm_backward(dhidden, x_normalized, gamma, beta, sample_mean, sample_var, hidden,
                                                1e-5)
